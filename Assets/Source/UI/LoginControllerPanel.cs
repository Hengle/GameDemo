...
//        base.Awake();
//        EventManage.Instance.AddEventListener((int)EventHandlerID.ShowLogin, ShowLogin);
//        NetManager.Instance.OnNetWorkStateChanged = OnNetWorkStateChanged;
//    }
...
//        {
//            Debug.Log("[login] connect timeout");
//        }
//        else if (state == NetWorkState.Disconnected)
//        {
//            Debug.Log("[login] dis connect");
//        }
...
//        NetManager.Instance.Connect(m_loginModel.m_ip, Convert.ToInt32(m_loginModel.m_port), OnHandShaked);
//    }

//    private void OnHandShaked()
//    {
//        LoginRequest loginRequest = new LoginRequest();
//        //loginRequest.Uid = m_loginModel.m_uid;
//        loginRequest.UserName = m_loginModel.m_userName;    // 名称
//        loginRequest.DeviceId = m_loginModel.diviceID; // 设备名
//        loginRequest.AppVersion = string.Empty;
//        loginRequest.Pf = string.Empty;
//        loginRequest.Lang = string.Empty;
//        loginRequest.Ptype = 0;

//        MapField<string, string> mapFiled = new MapField<string, string>() { { "", ""} };
//        loginRequest.Params.Add(mapFiled);
//        loginRequest.ZoneName = "S1";                   // 大区名

//        NetManager.Instance.Request( ProtocolId.Login, loginRequest, OnLoginOk,OnLoginError);
...
//    {
//        Debug.Log("[loginok]==================================");
//        LoginResponse rec = LoginResponse.Parser.ParseFrom(data);
//        EventManage.Instance.DispachEvent((int)EventHandlerID.LoginResponse, rec);

//        ManagerScene.LoadScene(SceneEnum.Castle);
//        Show(false);
//    }

//    private void OnLoginError(byte[] data)
//    {
//    }
